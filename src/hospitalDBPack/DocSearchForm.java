...
/**
 * The user can search for any doctor entry
...
public class DocSearchForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DocSearchForm frame = new DocSearchForm();
	...
	public DocSearchForm() {
		...
		setTitle("Insert/Search Doctors");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DocSearchForm.searchEpwnymoVar = frm_SearchEpwnymo.getText();
				HospitalApp.docSearchFrame.setEnabled(false);
				HospitalApp.docUpdateFrame.setVisible(true);
			}
		});
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HospitalApp.docInsertFrame.setVisible(true);
				HospitalApp.docSearchFrame.setEnabled(false);
			}
		});
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				HospitalApp.docSearchFrame.setVisible(false);
			}
		});
